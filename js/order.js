$(document).ready(function() {
    ...
    $.ajax({
        ...
        success: function(a, b, d) {
            ...
            document.getElementById("usernamevalue").value = e.username;
...
function checkmilk(checkbox)
{
    if (checkbox.checked)
    {
       // alert("a");
       document.getElementById("milkrow").style.display = "";
    }

    else
    {
        document.getElementById("milkrow").style.display = "none";
    }
}